...
describe('parse-ascii-table', () => {
    describe('given a table with no rows and columns', () => {
        it('returns an empty grid', () => {
            const emptyTable = '';
            expect((0, parse_ascii_table_1.default)(emptyTable)).toEqual([]);
        });
    });
...
|  |
|--|`;
                expect((0, parse_ascii_table_1.default)(table)).toEqual([[undefined]]);
            });
        });
...
| 1 |
|---|`;
                expect((0, parse_ascii_table_1.default)(table)).toEqual([['1']]);
            });
...
|---|`;
                    ...
                    expect((0, parse_ascii_table_1.default)(table, customResolver)).toEqual([
                        [1]
                    ]);
                });
            });
...
| 2 |
|---|`;
                expect((0, parse_ascii_table_1.default)(table)).toEqual([['1'], ['2']]);
            });
        });
...
| 10 |
|----|`;
                expect((0, parse_ascii_table_1.default)(table)).toEqual([['1'], ['10']]);
            });
        });
    });
...
| 12 | 10 |
|----|----|`;
            expect((0, parse_ascii_table_1.default)(table)).toEqual([
                [' 1', undefined],
                ['12', '10']
            ]);
        });
